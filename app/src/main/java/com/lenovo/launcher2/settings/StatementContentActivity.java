...
public class StatementContentActivity extends Activity {
    ...
    void popupPromotion(final Context context) {
		...
		mAlertDialog.setLeTitle(R.string.private_statement);
		mAlertDialog.setLeMessage(R.string.private_statement_content);
