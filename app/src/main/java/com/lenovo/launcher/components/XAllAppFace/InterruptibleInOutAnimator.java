...
public class InterruptibleInOutAnimator {
    ...
    public InterruptibleInOutAnimator(long duration, float fromValue, float toValue, XContext context) {
        mXContext = context;
    ...
    private void animate(int direction) {
        ...
        mXContext.getRenderer().injectAnimation(mAnimator, false);
...
//        mAnimator.start();
    ...
    public void cancel() {
//        mAnimator.cancel();
        mXContext.getRenderer().ejectAnimation(mAnimator);
        mDirection = STOPPED;
    }
