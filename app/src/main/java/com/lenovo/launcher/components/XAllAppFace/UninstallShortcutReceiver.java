    ...
    public void onReceive(Context context, Intent data) {
        ...
        if (intent != null && name != null) {
            ...
            Cursor c = cr.query(LauncherSettings.Favorites.CONTENT_URI,
                ...
                LauncherSettings.Favorites.TITLE + "=? and " + LauncherSettings.Favorites.ITEM_TYPE +" =" + LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT, new String[] { name }, null);
                ...
                while (c.moveToNext()) {
                    try {
                        if (intent.filterEquals(Intent.parseUri(c.getString(intentIndex), 0))) {
                            ...
                            XLauncherModel.deleteItemFromRAM(id);
