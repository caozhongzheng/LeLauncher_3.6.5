 ...
 * 
 */
public class NetworkHttpRequest5 {
			...
			if (RegisterClient5Response.getClientId() != null){
				httpget.addHeader(
						...
						"lpsust="
								...
								+ ";clientid="
								+ RegisterClient5Response.getClientId());
			}
			if(contentType!=null){
...
//					"application/x-www-form-urlencoded");
			...
			Log.i(TAG, "NetworkHttpRequest5 >> executeHttpPost >> post >> 111111111111111111111111111 : "+post+" ::2222222222");
