...
public class RequestManager {
	...
	public static void executeHttpGet(Context context, String url, ILeHttpCallback callback) {
	...
	public static void executeHttpPost(Context context, String url, String postdata,
