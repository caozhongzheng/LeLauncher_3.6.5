...
public interface XDropTarget {
     ...
     * 
     */
    void onDrop(XDragObject dragObject);

    void onDragEnter(XDragObject dragObject);

    void onDragOver(XDragObject dragObject);

    void onDragExit(XDragObject dragObject);
     ...
     */
    XDropTarget getDropTargetDelegate(XDragObject dragObject);
     ...
     */
    boolean acceptDrop(XDragObject dragObject);
